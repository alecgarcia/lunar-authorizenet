...
// config for alecgarcia/LunarAuthorizeNet
return [
    /*
    |--------------------------------------------------------------------------
    ...
    |--------------------------------------------------------------------------
    |
    | Set what environment Authorize.Net will use. If not set, defaults to sandbox unless application is in production.
    | The environment can be set to either `sandbox` or `production`.
    |
    */

    'environment' => env('AUTHORIZE_NET_ENVIRONMENT'),
